...
<div>
    ...
    <input type="text" name="d-de-sortie" id="date-de-sortie" <?php if(isset($execResult)){ echo $execResult[0]["d-de-sortie"];} ?>>
</div>
...
<a href="./conn.php" title="Redirection sur la page de tous les utilisateurs">Afficher tous les jeux pokémon</a>
